...
1. Clone the repository:
   ```bash
   git clone https://github.com/snap-stanford/Amplicon.git
   cd Amplicon/amplicon_env
   ```
...
3. Lastly, to activate the amplicon environment:
```bash
...
The Amplicon environment comes with a minimal set of langchain packages by default:
