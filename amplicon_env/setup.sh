...
# BioAgentOS - Amplicon Environment Setup Script
...
echo -e "${YELLOW}=== Amplicon Environment Setup ===${NC}"
...
install_cli_tools() {
    ...
    export AMPLICON_TOOLS_DIR="$TOOLS_DIR"
    ...
    if [ $? -eq 0 ]; then
        ...
        echo "# Added by amplicon setup" >> setup_path.sh
    ...
    unset AMPLICON_AUTO_INSTALL
    unset AMPLICON_TOOLS_DIR
}
...
main() {
    ...
    # Setup completed
    echo -e "\n${GREEN}=== Amplicon Environment Setup Completed! ===${NC}"
