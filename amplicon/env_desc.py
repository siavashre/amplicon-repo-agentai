...
_amplicon_data_dir = _os.path.join(
    _os.getenv("AMPLICON_PATH") or _os.getenv("AMPLICON_DATA_PATH") or "./data",
    "amplicon_data", "data_lake", "amplicon_data",
)
_amplicon_files = {
...
_cycle_data_dir = _os.path.join(
    _os.getenv("AMPLICON_PATH") or _os.getenv("AMPLICON_DATA_PATH") or "./data",
    "amplicon_data", "data_lake", "cycle_files",
)
_cycle_files = {
...
_graph_data_dir = _os.path.join(
    _os.getenv("AMPLICON_PATH") or _os.getenv("AMPLICON_DATA_PATH") or "./data",
    "amplicon_data", "data_lake", "graph_files",
)
_graph_files = {
