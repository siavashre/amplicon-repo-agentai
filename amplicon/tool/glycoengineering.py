...
Functions return research-log style strings to match Amplicon tool patterns.
"""
...
def list_glycoengineering_resources() -> str:
    ...
    lines.append("- For tight Amplicon integration, consider adding MCP wrappers or CLI installers.")
    return "\n".join(lines)
