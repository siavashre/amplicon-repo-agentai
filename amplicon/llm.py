...
if TYPE_CHECKING:
    from amplicon.config import AmpliconConfig
...
def get_llm(
    ...
    Args:
        ...
        config (AmpliconConfig): Optional configuration object. If provided, unspecified parameters will use config values
    """
