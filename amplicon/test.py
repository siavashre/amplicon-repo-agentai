...
agent.go("Ask the user for a dataset then compute the Pearson correlation between captured interval length and feature maximum copy number for ecDNA and BFB amplification features. Return the Pearson correlation coefficient and number of features for each classification.")
