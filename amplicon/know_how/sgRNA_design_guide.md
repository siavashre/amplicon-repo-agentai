...
Use `advanced_web_search_claude` from `amplicon.tool.literature` to find validated sgRNAs from literature and databases:

```python
from amplicon.tool.literature import advanced_web_search_claude
